...
const server = new GraphQLServer({
  typeDefs: path.join(__dirname, 'src/graphql-server/schema.graphql'), //This is schema for GraphQL API
  resolvers,
  context(req) {
    return {
      ...req,
      worldGame: worldGame,
      prisma: new Prisma({
        typeDefs: path.join(__dirname, 'src/graphql-server/generated/prisma.graphql'), //This is schema for Prisma-binding between GraphQL API & Prisma API.
